...
/** @class BinTree
*   @brief Árbol genérico que o bien está vacío o bien todo subárbol suyo tiene exactamente dos hijos. 
           Todas las operaciones tienen un costo constante. 
*/
template <typename T> class BinTree {
/** @struct Node
*   @brief Es un struct "nódo" del árbol binario.
*/
    struct Node {
        T x;
